...
## Run
  ...
  # run the automated script that evaluated the correlation between Google search frequencies of selected keywords and egg prices
  python3 compare_trend_price.py

  # run the interactive web application that enables users to test keyword combinations in real time
  python3 -m streamlit run web_trend_price.py

  # the live web app prototype demo
  https://foodpricetrend.streamlit.app
